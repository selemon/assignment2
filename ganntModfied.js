...
d3.gantt = function() {
    ...
    function gantt(data) {
        ...
        var svg = d3.select("body").select("#school")
            .append("svg")
            .attr("class", "chart")
    ...
    gantt.redraw = function(data) {
        ...
        var rect = ganttChartGroup.selectAll("rect").data(data, keyFunction);
        ...
        //set up the text when a rect is clicked on
